...
export function InputField(props) {
    return (
        <input type={ check_field(props.type) ? props.type : 'text' } className='input-field' style={{ width: props.type === 'number' ? '46px' : '', textAlign: props.type === 'number' ? 'center' : '', border: props.border === 'none' ? 'none' : '', ...props.style }} { ...props } />
    );
}
